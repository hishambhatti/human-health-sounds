...
export default function About() {
  return (
    <div className='min-h-screen bg-[#f4f3ef] flex flex-col items-center py-16 px-6 font-[Poppins,sans-serif]'>
    {/* Title */}
    <h1 className='text-2xl font-light tracking-wide mb-8 text-gray-800'>
      BIRD SOUNDS
    </h1>
    ...
    <p className='mb-4'>
      ...
      for his support. The audio clips are provided by{" "}
        <a
        ...
        >
          VocalSound
        </a>. The open-source code is available{" "}
        <a
